    ...
    public class InputManager
    {
        ...
        void LoadDefaultMappings()
        {
            ...
            */
            ...
            var xbox = OpenDeviceByNameOrGuid("Keyboard", null);
            var objects = xbox.Device.GetObjects();

            AddNormalizedAxisMapping(INPUT_TYPE.YAW_AXIS, xbox, "Key39", false, false);
            AddNormalizedAxisMapping(INPUT_TYPE.CLIMB_DESCEND_AXIS, xbox, "Key1", true, false);
            AddNormalizedAxisMapping(INPUT_TYPE.PITCH_AXIS, xbox, "Key2", true, false);
            AddNormalizedAxisMapping(INPUT_TYPE.ROLL_AXIS, xbox, "Key3", false, false);
            AddNormalizedAxisMapping(INPUT_TYPE.CAMERA_TILT_AXIS, xbox, "Key37", true, false, 50);
            AddButtonMapping(INPUT_TYPE.TAKE_OFF, xbox, "Key38", false);
            AddButtonMapping(INPUT_TYPE.LAND, xbox, "Key40", false);
            AddButtonMapping(INPUT_TYPE.FLAT_TRIM, xbox, "Key41", false);
            AddButtonMapping(INPUT_TYPE.TAKE_PHOTO, xbox, "Key42", false);
            AddButtonMapping(INPUT_TYPE.START_VIDEO, xbox, "Key43", false);
            AddButtonMapping(INPUT_TYPE.STOP_VIDEO, xbox, "Key44", false);
        }
